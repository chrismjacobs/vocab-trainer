          ...
          <div class="p-3 bg-warn" style="height:100%">
              ...
              <hr>
                    ...
                    <div v-if="isAuthenticated">
                      ...
                      <button v-if="$store.state.userProfile.userID === 2" class="buttonDiv mt-2 bg-grape text-cream px-1" style="height:50px; width:100%" @click="goTo('JGrabber')"><b-icon-person-fill></b-icon-person-fill>  <span> &nbsp;JSON </span> </button>
                      <button v-if="$store.state.userProfile.userID === 2" class="buttonDiv mt-2 bg-safe text-prime px-1" style="height:50px; width:100%" @click="goTo('ClassCodes')"><b-icon-person-fill></b-icon-person-fill>  <span> &nbsp;CODES </span> </button>
